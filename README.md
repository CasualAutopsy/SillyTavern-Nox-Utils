# SillyTavern-Nox-Utils

Nox's personal assortment of helpful macros ~~and STscript slash commands~~(Soon™).

## Pre-requisites

- [SillyTavern](https://github.com/SillyTavern/SillyTavern) (Obviously.)
- [STLibs-Nox-Library](https://github.com/CasualAutopsy/STLibs-Nox-Library)

## Installation

1. Make sure you have all the pre-requisites installed.
2. Open the Extensions drawer and click `Install extension`.
